...
from math_verify import parse as parse_hf
from math_verify import verify as verify_hf
...
def math_equal_hf(prediction, reference):
    gold = parse_hf(reference)
    answer = parse_hf(prediction)
    return verify_hf(gold, answer)
